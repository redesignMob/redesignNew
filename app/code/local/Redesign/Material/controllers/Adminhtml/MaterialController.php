...
class Redesign_Material_Adminhtml_MaterialController extends Mage_Adminhtml_Controller_action
{
    ...
    public function massStatusAction()
    {
        ...
        if(!is_array($materialIds)) {
            ...
            try {
                foreach ($materialIds as $materialId) {
                    $material = Mage::getSingleton('material/material')
                        ->load($materialId)
                ...
                $this->_getSession()->addSuccess(
                    $this->__('Total of %d record(s) were successfully updated', count($materialIds))
                );
            } catch (Exception $e) {
    ...
    public function exportCsvAction()
    {
        ...
        $content    = $this->getLayout()->createBlock('material/adminhtml_material_grid')
            ->getCsv();
