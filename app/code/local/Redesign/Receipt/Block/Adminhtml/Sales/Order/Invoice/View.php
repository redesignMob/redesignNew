 ...
 */
class Redesign_Receipt_Block_Adminhtml_Sales_Order_Invoice_View extends Mage_Adminhtml_Block_Sales_Order_Invoice_View {
    ...
    public function __construct() {
        ...
        $this->_addButton('print_with_receipt', array(
            'label' => Mage::helper('sales')->__('Print with Receipt'),
            'class' => 'save',
            'onclick' => 'setLocation(\'' . $this->getPrintWithReceiptUrl() . '\')'
                )
        );
        $this->_addButton('add_receipt', array(
            'label' => Mage::helper('sales')->__('Increment Receipt Number'),
            'class' => 'save',
            'onclick' => 'setLocation(\'' . $this->getAddReceiptUrl() . '\')'
                )
        );
    }

    public function getPrintWithReceiptUrl() {
    ...
    public function getAddReceiptUrl() {
        return $this->getUrl('*/*/receipt', array(
                    'invoice_id' => $this->getInvoice()->getId()
                ));
    }
